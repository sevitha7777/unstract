...
class UserSessionResponseSerializer(serializers.Serializer):
    ...
    adapters = serializers.ListField(child=serializers.CharField(), required=False)
    ...
    orgId = serializers.CharField(required=False, allow_null=True)
    orgName = serializers.CharField(required=False, allow_null=True)
    csrfToken = serializers.CharField(required=False, allow_null=True)
    zCode = serializers.CharField(required=False, allow_null=True)
    isAdmin = serializers.BooleanField(required=False)
    logEventsId = serializers.CharField(required=False, allow_null=True)
    allOrganization = serializers.ListField(required=False)
    isPlatformAdmin = serializers.BooleanField(required=False)
    loginOnboardingMessage = serializers.CharField(required=False, allow_null=True)
    promptOnboardingMessage = serializers.CharField(required=False, allow_null=True)
    flags = serializers.DictField(required=False)
